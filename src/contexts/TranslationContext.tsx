...
const translations = {
  english: {
    ...
    advancedForecasting: 'Advanced forecasting for flood, heatwave, and pollution risks',
  ...
  hindi: {
    ...
    advancedForecasting: 'बाढ़, गर्मी की लहर और प्रदूषण जोखिमों के लिए उन्नत पूर्वानुमान',
  ...
  tamil: {
    ...
    advancedForecasting: 'வெள்ளம், வெப்பஅலை மற்றும் மாசுபாடு அபாயங்களுக்கான மேம்பட்ட கணிப்பு',
  ...
  malayalam: {
    ...
    advancedForecasting: 'വെള്ളപ്പൊക്കം, ചൂട്ടലകൾ, മലിനീകരണ അപകടങ്ങൾക്കുള്ള വിപുലമായ പ്രവചനം',
